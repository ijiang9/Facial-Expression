...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 27 16:55:18 2020
...
generate_dataset = Generate_data(path)
...
traincsv_file = path+'/train.csv'
validationcsv_file = path+'/val.csv'
train_img_dir = path+'/train/'
validation_img_dir = path+'/val/'
...
optmizer= optim.Adam(net.parameters(),lr= lr,weight_decay=1e-5)
